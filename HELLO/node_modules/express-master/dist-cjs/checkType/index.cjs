...
const checkItem_js_1 = __importDefault(require("./checkItem.cjs"));
...
_Check_required = new WeakMap(), _Check_instances = new WeakSet(), _Check_getOptions = function _Check_getOptions(type, config) {
    ...
    return (object, options = {}) => {
        (0, checkItem_js_1.default)(object, __classPrivateFieldGet(this, _Check_instances, "m", _Check_getOptions).call(this, type, options));
    };
};
...
exports.default = new RequiredCheck(true);
